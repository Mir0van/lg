...
var _scrollToTop = require("./modules/burger/scroll-to-top");
var _spin = require("./modules/spin/spin");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _spin.initRotateImg)();
    (0, _inputValidate.initValidate)();
  });
});

},{"./modules/api/api":2,"./modules/burger/burger":3,"./modules/burger/scroll-to-top":4,"./modules/spin/spin":5,"./modules/validate/input-validate":6,"./utils/ios-vh-fix":9}],2:[function(require,module,exports){
"use strict";
...
var text = document.querySelector('[data-api-description]');
...
var scrollToTopButton = document.querySelector('[data-burger]');
...
var initRotateImg = exports.initRotateImg = function initRotateImg() {
